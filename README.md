# python-challenge
This is the repository that holds my Module 3 Python-Challenge.
...
Please note that I requested/received help from 3 people through Slack's AskBCS Lerning Assistant and used the following resources:
