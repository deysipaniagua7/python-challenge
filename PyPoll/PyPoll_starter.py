...
total_candidate_votes = {} # Define lists and dictionaries to track candidate names and vote counts
...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if candidate_name not in total_candidate_votes:
...
with open(file_to_output, "w") as txt_file:
    ...
    for candidate, votes in total_candidate_votes.items():
        ...
        if votes > winning_count_tracker:
            winning_count_tracker = votes
            winning_candidate = candidate
            winning_count_percentage = vote_percentage
